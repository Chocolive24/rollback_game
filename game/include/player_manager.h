...
class PlayerManager {
 public:
  ...
  /**
   * \brief Copy is a method which copies the states of the players. It used
   * when rollback is applied to go back to the previous players state. \param
   * player_manager The player manager to be copied.
   */
